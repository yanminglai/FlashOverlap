...
void mutlass_gemm_signal(int M, int N, int K, int ReLDN, int* CommThr,
                         ...
                         bool Monitor, musaStream_t stream) {
...
#define MUTLASS_SIGNAL_INIT(TileM, TileN, TileK)                            \
    template void mutlass_gemm_signal<TileM, TileN, TileK>(                 \
